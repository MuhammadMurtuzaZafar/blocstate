          ...
          children: [
            Container(
              ...
              image: DecorationImage(
                image: AssetImage(itemListController.fruitList[index]
            ...
            Obx(() => Align(
                  ...
                  child: InkWell(
                    onTap: () => itemListController.selectedItem(itemListController.fruitList[index]),
                    child: Container(
                      padding: const EdgeInsets.all(8),
                      margin: const EdgeInsets.all(10),
                      decoration: BoxDecoration(
                          color:
                              itemListController.fruitList[index].selected.value
                                  ? Colors.red
            ...
            Align(
              ...
              child: Container(
                ...
                child: Text(
                  "${itemListController.fruitList[index].price}",
